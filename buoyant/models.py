...
class Meteorological(models.Model):
    ...
    wind_gust = models.DecimalField(max_digits=5, decimal_places=1)
    wave_height = models.DecimalField(max_digits=5, decimal_places=1)
    dom_wave_period = models.DecimalField(max_digits=5, decimal_places=1)
    avg_wave_period = models.DecimalField(max_digits=5, decimal_places=1)
    wave_dir = models.PositiveSmallIntegerField()
    sea_pressure = models.DecimalField(max_digits=5, decimal_places=1)
    air_temp = models.DecimalField(max_digits=5, decimal_places=1)
    sea_temp = models.DecimalField(max_digits=5, decimal_places=1)
    tide = models.CharField(max_length=6)
    dewpoint_temp = models.DecimalField(max_digits=5, decimal_places=1)
    station_visibility = models.DecimalField(max_digits=5, decimal_places=1)
